...
-record( pod_series,         { pod_ID, series = #series{} }).  % effectively an abstract type
-record( service_series,     { pod_ID, series = #series{} }).  % Need this for mnesia - to separate tables
-record( transformer_series, { pod_ID, series = #series{} }).  % Need this for mnesia - to separate tables
-record( circuit_series,     { pod_ID, series = #series{} }).  % Need this for mnesia - to separate tables
...
-record( object, { key                     % { type, ID }
	               , object_record           % the object's record
								 } ).   
