...
tick_load_test( Fanout ) ->
		...
		% TODO: Separate this into another test module -- (Note: It depends on tick but not on Fanout)
		?debugTime("price day's usage", messenger:send_notice_to_actor( { cascade, price }, NodeID ) ),
		
		meters:close(),
		
		% TODO: Separate this into another test module -- (Note: It depends on tick but not on Fanout)
		?debugTime( "market_price intervals for cycle 19:", channels:market_price( 19, dummyPriceSchedule ) ),
		%?debugTime( "market_price intervals for cycle 2:", channels:market_price( 2, dummyPriceSchedule ) ),
		%?debugTime( "market_price intervals for cycle 0:", channels:market_price( 0, dummyPriceSchedule ) ),
