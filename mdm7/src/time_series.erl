...
%%% Exported Functions
%%%
-export([add/2, subtract/2, put_into/2, multiply/4, scale/4, divide/4
				, new/2, new/3, put/3, put/4, put_day/3, extract/3, extract/5
				, make_test_day/0, make_test_day/1 
				]).
...
new( SeriesType, UnitOfMeasure ) ->
		new( SeriesType, UnitOfMeasure, 3600 ).
