...
% Meter is a Device   ( meter oid == device oid)
-record( meter, { oid, type_of_meter, meter_configuration, service }).  % asset_attributes holds the actual configuration parameters
...
-record( service, { oid, type, premise, coordinates, circuit, transformer
									, service_agreement, service_events } ).
