...
init([]) ->
		...
		open_table( service_series_table
...
terminate(Reason, State) ->
		...
		flush(),
		dets:close( service_series_table ),
...
add_series_into_PoD_history( PoD_Series ) ->
		...
		Service_PoD_Series = 
				        case dets:lookup( service_series_table, ServiceID ) of 
		...
		dets:insert( service_series_table, Updated_PoD_Series ),
...
flush() ->
		dets:sync( service_series_table ),
